...
export default function PDFViewer(props: Props) {
    ...
    return (
        <div
            className="border border-gray-300 rounded-md p-2 h-1.2 w-6/12 mx-auto"
        >
            <Worker
                workerUrl="https://unpkg.com/pdfjs-dist@3.7.107/build/pdf.worker.js"
            ...
            >
                ...
                >
                    <Toolbar
                        key={`document-${getUniqueKey(document)}-toolbar`}
                    >{renderDefaultToolbar(transform)}</Toolbar>
                </div>
