...
export default function BuyDialogForm({
  open,
  closeHandler,
  price,
  adminFee,
        ...
        <form className="flex flex-col gap-5 mx-5">
          ...
          <div className="form-control w-full mt-4">
            ...
            <TextInput
              ...
              onChange={e =>
                form.setData('ticket_amount', Number(e.currentTarget.value))
              }
              required
            />
            {/* <InputError className="mt-2" message={"salah"} /> */}
          ...
          <div className="form-control w-full mt-4">
            ...
            <select
              ...
              onChange={e =>
                form.setData('payment_method', e.currentTarget.value)
              }
              required
            >
          ...
          <div className="flex justify-center">
            <div className="grid grid-cols-3 gap-3 justify-center">
              <div className="flex flex-col">
                <div className="font-bold text-center">Harga per Tiket</div>
                <div className="text-center">Rp. {price?.toLocaleString()}</div>
              </div>
              <div>
                <div className="font-bold text-center">Biaya Langganan</div>
