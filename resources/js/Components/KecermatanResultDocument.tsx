        ...
        <div className="w-full">
                ...
                <div>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                {`${new Date(exam.created_at).toLocaleDateString("id-ID", { "weekday": "long" })}, ${new Date(exam.created_at).toLocaleDateString("id-ID", { "day": "numeric" })
                                    } ${new Date(exam.created_at).toLocaleDateString("id-ID", { "month": "long" })
                                    } ${new Date(exam.created_at).toLocaleDateString("id-ID", { "year": "numeric" })}`}
                            </td>
                        </tr>
                        <tr>
                            <td>Waktu </td>
                ...
                <div>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                {`${new Date(exam.created_at).toLocaleTimeString("id-ID", { "hour": "numeric", "minute": "numeric" })} / ${new Date(exam.updated_at).toLocaleTimeString("id-ID", { "hour": "numeric", "minute": "numeric" })}`}
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>:</td>
                            <td>
                                {exam.finished_at ? "Tes Selesai" : "Tes Belum Selesai"}
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div className="p-1">
                <table className="w-full text-center">
                    ...
                    <tr className="items-center">
                        <td className="text-left border border-black pl-1">
                            Kolom 1
                        </td>
            ...
            <div className="flex justify-end text-lg font-bold">
                <div className="w-1/4">
                    ...
                    <p className="mt-10 underline-offset-2 underline">
                        Admin CAT
                    </p>
                </div>
            </div>
