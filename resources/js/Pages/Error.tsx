    ...
    return (
        <>
            ...
            <div
                ...
                style={{
                    background: "linear-gradient(180deg, #116BF2 0%, rgba(49, 176, 168, 0.85) 33.33%, rgba(145, 168, 203, 0.55) 99.99%, rgba(255, 255, 255, 0.00) 100%)",
                }}>
                <div className="my-auto flex gap-10">
                    ...
                    <div>
                        <img src={asset("root", `assets/image/errors/${title}.png`)} alt={status.toString()} className="h-96 max-h-96 max-w-3xl" />
                    </div>
                </div>
            </div>
        </>
