        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <div className="flex flex-col gap-3 ">
            <div className="flex flex-col gap-3 p-auto basis-1/2 p-3 md:p-10 rounded-2xl border-stone-600 border-2">
              <p className="text-xl md:text-4xl">Balikpapan Fest 2023</p>
              ...
              <div className="border-black border-t-2 text-md md:text-xl my-5">
                ...
                <p className="font-bold">MBC Entertainment</p>
              </div>
            </div>
            <div className="flex justify-center">
              <button
                className="bg-blue-400 hover:bg-blue-500 text-xl text-white font-bold py-3 px-7 rounded-lg"
                onClick={handleOpen}
              >
                Beli Tiket
              </button>
          ...
          <div className="p-10  h-96 rounded-2xl">
            <div>
              ...
              <TabPanel value={tabValue} index={0}>
                <div className="my-auto text-4xl">Deskripsi</div>
              </TabPanel>
              <TabPanel value={tabValue} index={1}>
                <div className="flex flex-col my-3 gap-3">
                  <div className="p-4 border-stone-600 border-2 flex flex-col gap-2">
                    ...
                    <p>Harga Belum Termasuk Pajak dan Biaya Layanan</p>
                    <div className="border-black border-t-2 text-md md:text-xl my-5 flex justify-between py-3">
                      ...
                      <p className="font-semibold text-pink-500">PROMO ENDED</p>
                    </div>
                  </div>
                  <div className="p-4 border-stone-600 border-2 flex flex-col gap-2">
                    <p className="text-xl text-cyan-500 font-bold">
                    ...
                    <div className="border-black border-t-2 text-md md:text-xl my-5 flex justify-between py-3">
                      ...
                      <button
                        className="bg-blue-400 hover:bg-blue-500 text-xl text-white font-bold py-1 px-7 rounded-lg"
                        onClick={handleOpen}
                      >
                        Beli Tiket
                      </button>
